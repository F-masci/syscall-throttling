...
#define SCT_IOCTL_GET_SYSCALL_LIST _IOR(SCT_IOC_MAGIC, 5, struct list_query_t)
#define SCT_IOCTL_GET_UID_LIST _IOR(SCT_IOC_MAGIC, 6, struct list_query_t)
#define SCT_IOCTL_GET_PROG_LIST _IOR(SCT_IOC_MAGIC, 7, struct list_query_t)
