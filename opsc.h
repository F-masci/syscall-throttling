...
#define SCT_IOCTL_GET_STATUS		_IOR(SCT_IOC_MAGIC, 4, struct monitor_status_t)
#define SCT_IOCTL_GET_SYSCALL_LIST  _IOWR(SCT_IOC_MAGIC, 5, struct list_query_t)
#define SCT_IOCTL_GET_UID_LIST	  _IOWR(SCT_IOC_MAGIC, 6, struct list_query_t)
#define SCT_IOCTL_GET_PROG_LIST	 _IOWR(SCT_IOC_MAGIC, 7, struct list_query_t)

#define SCT_IOCTL_GET_STATS		 _IOR(SCT_IOC_MAGIC, 8, struct throttling_stats_t)
#define SCT_IOCTL_GET_PEAK_DELAY	_IOR(SCT_IOC_MAGIC, 9, struct sysc_delayed_t)
...
#define SCT_IOCTL_SET_FAST_UNLOAD   _IOW(SCT_IOC_MAGIC, 15, bool)