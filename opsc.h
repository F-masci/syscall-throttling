...
#define SCT_IOCTL_GET_SYSCALL_LIST  _IOWR(SCT_IOC_MAGIC, 5, list_query_t)
#define SCT_IOCTL_GET_UID_LIST      _IOWR(SCT_IOC_MAGIC, 6, list_query_t)
#define SCT_IOCTL_GET_PROG_LIST     _IOWR(SCT_IOC_MAGIC, 7, list_query_t)

#define SCT_IOCTL_GET_STATS         _IOR(SCT_IOC_MAGIC, 8, throttling_stats_t)
#define SCT_IOCTL_GET_PEAK_DELAY    _IOR(SCT_IOC_MAGIC, 9, sysc_delayed_t)
